...
/// POST /actions/<action_id>/ttl -> extend/update TTL for an action (admin only)
#[post("/actions/<action_id>/ttl", data = "<payload>")]
...
/// GET /actions/<action_id>/ttl -> fetch remaining TTL (seconds)
#[get("/actions/<action_id>/ttl")]
